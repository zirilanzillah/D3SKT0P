    ...
    public partial class TransparentOverlay : Form
    {
        ...
        private async Task AnimateMovementAcrossScreen()
        {
            ...
            while (true)
            {
                ...
                while ((this.Left < screenWidth - 72) && _currentDirection == Direction.Right) // .gif Width = 64 px; this.Width = 136 px
                {
                    if (_isDragging || _isFalling) { await Task.Delay(100); continue; }

                    if (random.Next(10000) < 1)
                    {
                        ...
                        if (random.Next(2) == 0) { speed = WalkSpeed; SetAnimation(Resources.EselWalkingToRight); }
                ...
                while (this.Left > 0 && _currentDirection == Direction.Left)
                {
                    if (_isDragging || _isFalling) { await Task.Delay(100); continue; }
                    ...
                    if (random.Next(10000) < 1)
                    {
                        ...
                        if (random.Next(2) == 0) { speed = WalkSpeed; SetAnimation(Resources.EselWalkingToLeft); }
